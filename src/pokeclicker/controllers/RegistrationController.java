...
import javafx.scene.control.typebutton;
...
import pokeclicker.manager.PokemonManager;
public class RegistrationController implements Initializable {

@FXML private ImageView pokedexbg, selectedimage;
@FXML private TextField  inputField;
@FXML private Label namelabel,healthlabel,pricelabel,startmessage,healtherrorlabel,imageErrorlabel;
@FXML private Button imageselectbutton;
@FXML private Label fixedname, fixedhealth, fixedprice,inputErrorlabel, createpokemonlabel;
...
fields = new Label[]{namelabel, healthlabel, pricelabel, createpokemonlabel};
    ...
    private void okbutton(ActionEvent event) {
        ...
        Pokemon pokemon = PokemonManager.createPokemon(pokemonname, totalHealth, abilities, price, type, imagepath);
...
private void imageselect(ActionEvent event) {
    ...
    try {
        ...
        FXMLLoader loader = SceneSwitcher.switchToSceneWithController(stage, "/pokeclicker/views/imageselection.fxml");
...
stringtype = String.valueOf(type);
    ...
    selectedimage.setFitWidth(100); selectedimage.setPreserveRatio(true);
