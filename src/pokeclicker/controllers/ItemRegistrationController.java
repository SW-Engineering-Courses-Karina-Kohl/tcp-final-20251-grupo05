...
public class ItemRegistrationController implements Initializable {
    ...
    @FXML
    private Label fixedname, fixedhealth, fixedprice, inputErrorlabel, createitemlabel, priceErrorlabel;
    @FXML
    private Line nameline, priceline, descriptionline;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        fixedhealth.setText("Price:");
        fixedprice.setText("Description:");
